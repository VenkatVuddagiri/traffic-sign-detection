...
def main():
    ...
    net = cv2.dnn.readNet("Input/yolov3_ts_train_5000.weights", "Input/yolov3_ts_train.cfg")
    ...
    classification_model = load_model('Input/my_model.h5') #load mask detection model
